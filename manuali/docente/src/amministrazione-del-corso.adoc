...
Una volta entrati nel corso, per modificare le sue impostazioni, basterà 
premere sull'ingranaggio cerchiato in rosso per aprire un menù a tendina
...
Cliccando successivamente su "`Impostazioni`" si aprirà la pagina per 
...
Una volta modificate le informazioni, per salvarle, basterà cliccare su
"`Salva e visualizza`"
...
Nella pagina della visualizzazione dei partecipanti è possibile anche creare dei sotto gruppi del corso.
Cliccando sul simbolo dell'ingranaggio a destra, verrà visualizzato un menù a tendina
...
Cliccando su "`Gruppi`", il sito vi porterà nella seguente pagina.
Questa pagina vi permette di creare un gruppo cliccando su "`Crea gruppo`"
...
Una volta immesse tutte le informazioni del gruppo, per il completamento dell'operazione,
 basterà cliccare su "`Salva modifiche`"
...
Creato il gruppo, vi basterà selezionarlo e cliccare su "`Aggiungi/rimuovi utenti`" 
per aggiungere o rimuovere partecipanti
...
partecipanti con molta facilità
