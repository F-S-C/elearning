...
"`<<sect-lezioni>>`") potrebbero avere la necessità di coprire tutti i tre
...
| Lo studente deve essere in grado di comprendere le principali differenze tra
  ...
  alterazioni all'interno dello spartito. *Valutazione:* test vero/falso, a
  risposta multipla o a corrispondenza con domande formulate in modo diverso
  rispetto al testo.
| * Conoscenza
  * Comprensione
...
| Lo studente deve comprendere l'importanza delle scale diatoniche e conoscere 
  ...
  test vero/falso e/o risposta multipla con domande formulate in modo diverso
  rispetto al testo.
| * Conoscenza
  * Comprensione
...
| Lo studente deve conoscere le tonalità delle varie note e il loro grado,
  ...
  vero/falso e/o a corrispondenza con domande formulate in modo diverso rispetto
  al testo.
| * Conoscenza
  * Comprensione
|===
...
| Lo studente deve conoscere quali sono le componenti fondamentali dello
  ...
  principi basilari della disciplina. *Valutazione:* test vero/falso a fine 
  lezione teorica, test propedeutico a risposta multipla con domande formulate
  in modo diverso rispetto al testo (presente a fine modulo) e consegna di una
...
| Lo studente deve essere in grado di comprendere cosa sono i rudimenti, quali
  ...
  su una batteria (o su un pad, o su una qualsiasi percussione). *Valutazione:*
  test vero/falso a fine lezione teorica, test propedeutico a risposta multipla
  con domande formulate in modo diverso rispetto al testo (presente a fine
  modulo) e consegna di uno o più video registrati per valutare la pratica.
| * Conoscenza
  * Comprensione
  * Applicazione
...
| Lo studente deve essere in grado comprendere cosa sono gli accenti e quali
  ...
  percussione). *Valutazione:* test vero/falso a fine lezione teorica, test 
  propedeutico a risposta multipla con domande formulate in modo diverso
  rispetto al testo (presente a fine modulo) e consegna di uno o più video
  registrati per valutare la pratica.
| * Conoscenza
  * Comprensione
  * Applicazione
|===
...
| Lo studente deve essere in grado di ricordare correttamente ed eseguire
  tutti i 24 accordi principali di base. *Valutazione:* test a risposta multipla
  e/o vero/falso con domande formulate in modo diverso rispetto al testo e
  consegne multiple di foto per valutare la pratica.
| * Conoscenza
  * Comprensione
  * Applicazione
...
| Lo studente deve essere in grado di applicare tutto quel che ha studiato
  ...
  accompagnamento del docente.*Valutazione:* La valutazione è rimandata 
  all'esame finale, un'esame "`orale`" in videoconferenza con il docente in cui
  lo studente dovrà mostrare ciò che ha imparato.
| * Conoscenza
  * Comprensione
  * Applicazione
