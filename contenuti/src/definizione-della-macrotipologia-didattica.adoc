...
| Lo studente deve conoscere quali sono le componenti fondamentali dello
  ...
  con domande formulate in modo diverso rispetto al testo e consegna di una
...
| Lo studente deve essere in grado di comprendere cosa sono i rudimenti, quali
  ...
  test a risposta multipla con domande formulate in modo diverso rispetto al
  testo e consegna di un video registrato per valutare la pratica.
| * Conoscenza
  * Comprensione
  * Applicazione
...
| Lo studente deve essere in grado comprendere cosa sono gli accenti e quali
  ...
  percussione). *Valutazione:* test a risposta multipla con domande formulate in
  modo diverso rispetto al testo e consegna di un video registrato per valutare
  la pratica.
| * Conoscenza
  * Comprensione
  * Applicazione
